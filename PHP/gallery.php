...
<div class="carousel-inner">
  <div class="carousel-item active">
										<?php 
										$result = $mysqli->query("SELECT image FROM gallery_upload WHERE id=1;");
	
										while($data = $result->fetch_assoc()) {
										echo "<img src='{$data['image']}' width='1100' height='500'>";
										}
  ...
  <div class="carousel-item">
										<?php 
										$result = $mysqli->query("SELECT image FROM gallery_upload WHERE id=2;");
  ...
  <div class="carousel-item">
										<?php 
										$result = $mysqli->query("SELECT image FROM gallery_upload WHERE id=3;");
  ...
  <div class="carousel-item">
										<?php 
										$result = $mysqli->query("SELECT image FROM gallery_upload WHERE id=4;");
  ...
  <div class="carousel-item">
										<?php 
										$result = $mysqli->query("SELECT image FROM gallery_upload WHERE id=5;");
