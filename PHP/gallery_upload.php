...
<head>
  ...
  margin-bottom: 0px;
	...
	.container .user-box input:focus ~ label, .container .user-box input:focus ~ label {
	top: -20px; 
	left: 0px; 
	color: #03E9F4;
	font-size: 12px;
...
<body>
	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a href="gallery_upload.php" class="nav-link">Gallery upload</a></li>
  ...
  <div class="container mt-5">
    <form action="" method="post" enctype="multipart/form-data" class="mb-3">
      <h3 class="text-center mb-5">GALLERY UPLOAD</h3>
